...
BONUSES = [
    ...
    (["google sheets"], 20),
    (["python"], 15),
    (["ai trainer", "ai evaluator", "ai tutor", "rlhf"], 25),
    (["ai annotation", "data annotation", "data labeling", "human feedback"], 25),
    (["virtual assistant"], 20),
    (["ocean freight", "supply chain", "operations analyst"], 20),
    (["ukrainian", "russian", "multilingual"], 15),
...
PENALTIES = [
    ...
    (["senior", "lead", "principal", "director", "manager", "staff engineer"], -30),
    (["us only", "canada only", "latam only", "brazil only", "india only"], -35),
    (["cyber security", "cybersecurity", "soc analyst", "intelligence analyst"], -45),
    (["physician", "medical doctor", "doctor", "nurse", "dentist", "pharmacist"], -45),
]
