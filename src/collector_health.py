...
def build_collector_health(collector_stats, candidate_pool=None):
    ...
    for row in collector_stats or []:
        ...
        health = {
            ...
            "country_restrictions": int_value(row, "country_restricted"),
            "worldwide_jobs": int_value(row, "worldwide_jobs"),
            "eu_jobs": int_value(row, "eu_jobs"),
            "rejected_by_country": int_value(row, "rejected_by_country"),
            "rejected_by_seniority": int_value(row, "rejected_by_seniority"),
            "rejected_by_profile": int_value(row, "rejected_by_profile"),
